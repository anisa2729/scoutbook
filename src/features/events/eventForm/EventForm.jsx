        ...
        {({ isSubmitting, dirty, isValid, values }) => (
          <Form className='ui form'>
            ...
            <MyPlaceInput
              ...
              // }}
            /> */}
            {/* <MyTextInput name='city.address' placeholder='City' /> */}
            <MyTextInput name='venue.address' placeholder='Location' />

            {/* <input name='city.address' placeholder='City' />
            <input name='venue.address' placeholder='Venue' /> */}
            <MyDateInput
              name='date'
